...
SHORTCUTS = (
    ...
    ("↑ / ↓", "Selection summary", "Previous / next position and its image"),
    ...
    (f"{COMMAND}+L", "Image Review", "Go to the well field"),
    (f"{COMMAND}+Shift+T", "Anywhere", "Show or hide the selection summary"),
    (f"{COMMAND}+Shift+P", "Image Review", "Show or hide the plate list"),
    ("Delete", "Selection summary", "Delete the selected positions"),
